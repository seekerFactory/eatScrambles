...
def testTopNMatches(critics, rmnd, name, category, matches=3):

	print("\n\n++++++++++++++++++++++++++++++++++++++++++++++++++++++")
	print("Top %d matches for critic %s in " %(matches, name) + '% '+ "for category %s\n" %(category))
	topm = rmnd.topMatches(critics, name, matches)
	for (prctg, name) in topm:
		print('%s : %f' % (name, prctg*100) + ' %')
	print("\n++++++++++++++++++++++++++++++++++++++++++++++++++++++")
	print("++++++++++++++++++++++++++++++++++++++++++++++++++++++\n\n")
...
def tested(rmnd, critics, testcase, critic_name, verbose=False):

	
	testTopNMatches(critics, rmnd, critic_name, testcase, 3)
...
if __name__ == '__main__':
	...
	parser = argparse.ArgumentParser(description='Recomendations and Ranking Tests', add_help=True)
